...
# TBL is an array of 256 integers. Each entry will be used to “jump” through the digits of π (pi)
# , based on the current state and the flag byte being tested.
...
def check_flag(flag):
    ...
    for i, c in enumerate(flag):
        ...
        print(int(test0), int(test1), int(test2), int(test3))
        # Even if the executable expects it to be True,
        # test3 is False for some characters of the valid flag...
        if test0 and test1 and test2: # and test3:
            sum += part
    return sum == 0x2c973df64
